...
public sealed class ExponentialMovingAverageRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExponentialMovingAverageRequest"/> class.
    /// </summary>
    /// <param name="ticker">The ticker symbol to calculate the indicator for.</param>
    public ExponentialMovingAverageRequest(string ticker)
    {
    ...
    /// <summary>
    /// The size of the window used to calculate the EMA.
    /// </summary>
