...
public sealed class SimpleMovingAverageRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SimpleMovingAverageRequest"/> class.
    /// </summary>
    /// <param name="ticker">The ticker symbol to calculate the indicator for.</param>
    public SimpleMovingAverageRequest(string ticker)
    {
