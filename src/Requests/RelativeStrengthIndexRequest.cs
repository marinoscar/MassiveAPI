...
public sealed class RelativeStrengthIndexRequest
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RelativeStrengthIndexRequest"/> class.
    /// </summary>
    /// <param name="ticker">The ticker symbol to calculate the indicator for.</param>
    public RelativeStrengthIndexRequest(string ticker)
    {
    ...
    /// <summary>
    /// The size of the window used to calculate the RSI.
    /// </summary>
